  ...
  \subsection{Failure semantics}
   ...
   \begin{figure}[H]
    ...
    \subsection{Independence hypothesis}  
        ...
        When load increases, the two components will start to show dependent behaviour due to the processor utilisation increasing. The $\Delta$Q of the observed total delay will then deviate from the sum of the two delays ($\Delta$Q$_1$, $\Delta$Q$_2$). 
