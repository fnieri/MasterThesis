\section{An overview of $\Delta$QSD}
 ...
 \subsection{Outcome}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{The outcome (circle) and the starting set (left) and terminating set (right) of events. We characterize a message travelling through the outcome with a $\Delta$Q.}
    \end{figure}
...
\subsection{Quality attenuation ($\Delta$Q)}
    ...
    The \textbf{\textit{intangible mass}} $1 - \lim_{x\to\infty}\Delta Q(x)$ of a $\Delta$Q will encode the probability of failure/timeout/exception occuring.
  ...
  \subsection{Failure semantics}
    ...
    \subsection{QTA, required $\Delta$Q}
         The Quantitative Timeliness Agreement maps objective measurements to the subjective perception of application performance \cite{dq-br}. It specifies what the base system does and its limits
