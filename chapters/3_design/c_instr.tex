\section{Oscilloscope side}
    ...
    As for operators, probes are automatically attached to the components inside them and to the operators' observables). 
    ...
    The \textbf{observed $\Delta$Q} for the first-to-finish operator is the observed$\Delta$Q for the observables (\textbf{start}, \textbf{end}). The \textbf{calculated $\Delta$Q} is the $\Delta$Q which is the result of the first-to-finish operator being applied on $o_1, o_2$.
